...
def power(reader, macro_x_pos: list[int]):
    ...
    for x_pos in macro_x_pos:
        for i in range(3):
            ...
            odb.dbSBox_create(vpwr_wire, met4, x, 7880, x + 1600, 144120, "STRIPE")
            odb.dbBox_create(vpwr_bpin, met4, x, 7880, x + 1600, 144120)
        for i in range(2):
            ...
            odb.dbSBox_create(vgnd_wire, met4, x, 7880, x + 1600, 144120, "STRIPE")
            odb.dbBox_create(vgnd_bpin, met4, x, 7880, x + 1600, 144120)
